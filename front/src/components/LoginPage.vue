...
<!--        <img src="../assets/login.jpg" id="icon" alt="User Icon" height="60" width="520"/>-->
      </div>

      <!-- Login Form -->
      <form @submit="onSubmit()" onsubmit="return false;">
        <input type="text" v-model="username" class="fadeIn second mt-3 mb-3" name="login" placeholder="enter your id"
               onfocus="this.placeholder = ''"
               onblur="this.placeholder = 'enter your id'">
        <input type="text" v-model="password" class="fadeIn third mt-3 mb-3" name="login"
